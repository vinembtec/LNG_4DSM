...
/*
#define RESET_IOPORT                                GPIO_PORT_P10
#define RESET_PIN                                   GPIO_PIN1
#define HFANT_CNTL									GPIO_PIN3//GPIO_PIN4
#define LFANT_CNTL									GPIO_PIN3

#define LORA_HF_PORT								GPIO_PORT_P10//GPIO_PORT_PJ
!
 * SX1276 SPI NSS I/O definitions

#define SPI_IOPORT                                  GPIO_PORT_P3
#define NSS_PIN                                     GPIO_PIN4
#define LRA_SCK_PIN									GPIO_PIN5
#define LRA_MOSI_PIN								GPIO_PIN6
#define LRA_MISO_PIN								GPIO_PIN7

#define RXTX_IOPORT									GPIO_PORT_P7
#define RXTX_PIN 									GPIO_PIN6
...
#define GET_TICK_COUNT( )                           ( RTC_epoch_now() )
