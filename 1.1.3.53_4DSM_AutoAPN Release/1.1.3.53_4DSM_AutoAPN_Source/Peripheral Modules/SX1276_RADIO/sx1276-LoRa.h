...
#define ALTERNATE_FREQUENCY					890000000
#define START_BAND					        902000000
...
typedef struct sSX1276LR
{
    ...
    uint8_t RegTestReserved2B;
    uint8_t RegRssiWideband;
    uint8_t RegTestReserved2D;
    uint8_t RegTestReserved2E;
    uint8_t RegTestReserved2F;
    uint8_t RegTestReserved30;
    ...
    uint8_t RegTestReserved34;
    uint8_t RegTestReserved35;
    uint8_t RegTestReserved36;
    uint8_t RegDetectionThreshold;                  // 0x37
    //uint8_t RegTestReserved38[0x3F - 0x38];         // 0x38-0x3F
    uint8_t RegTestReserved38;
    uint8_t RegTestReserved39;
    uint8_t RegTestReserved3A;
    uint8_t RegTestReserved3B;
    uint8_t RegTestReserved3C;
    uint8_t RegTestReserved3D;
    uint8_t RegTestReserved3E;
    uint8_t RegTestReserved3F;
   ...
   // uint8_t RegTestReserved45[0x4A - 0x45];         // 0x45-0x4A
    ...
    uint8_t RegTestReserved5E;
    uint8_t RegTestReserved5F;
    uint8_t RegTestReserved60;
    // Additional settings
